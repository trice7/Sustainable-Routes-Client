...
// TOGGLE FAVORITE
const toggleFavorite = (id) => new Promise((resolve, reject) => {
  console.warn(`Toggling favorite status for activity with id: ${id}`);
  fetch(`${clientCredentials.databaseURL}/activities/${id}/favorite`, {
    method: 'PUT',
    headers: {
      'Content-Type': 'application/json',
    },
...
export {
  deleteActivity, getActivity, getSingleActivity, toggleFavorite,
};
