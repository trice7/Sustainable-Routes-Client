...
const getFavoriteActivity = () => new Promise((resolve, reject) => {
  fetch(`${clientCredentials.databaseURL}/activities`, {
    method: 'GET',
    headers: {
      'Content-Type': 'application/json',
    ...
    .then((response) => response.json())
    .then((favorites) => resolve(setFavorites))
    .catch(reject);
});

export {
  deleteActivity, getActivity, getSingleActivity, getFavoriteActivity,
};
